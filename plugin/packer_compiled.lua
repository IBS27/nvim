...
vim.cmd [[au BufRead * ++once lua require("packer.load")({'todo-comments.nvim', 'trouble.nvim', 'indent-blankline.nvim', 'lspsaga.nvim', 'vim-sneak', 'which-key.nvim', 'nvim-colorizer.lua', 'zen-mode.nvim', 'nvim-spectre', 'nvim-ts-context-commentstring', 'quick-scope', 'gitsigns.nvim'}, { event = "BufRead *" }, _G.packer_plugins)]]
