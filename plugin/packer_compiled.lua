...
_G.packer_plugins = {
  ...
  ["nvim-dap"] = {
    config = { "\27LJ\2\nß\1\0\0\4\0\b\0\f6\0\0\0'\2\1\0B\0\2\0029\0\2\0B\0\1\0016\0\3\0009\0\4\0009\0\5\0'\2\6\0005\3\a\0B\0\3\1K\0\1\0\1\0\4\vlinehl\5\vtexthl\28LspDiagnosticsSignError\nnumhl\5\ttext\bÔ¥´\18DapBreakpoint\16sign_define\afn\bvim\nsetup\vnv-dap\frequire\0" },
    loaded = false,
    needs_bufread = false,
...
vim.cmd [[au BufRead * ++once lua require("packer.load")({'gitsigns.nvim', 'indent-blankline.nvim', 'nvim-ts-context-commentstring', 'quick-scope', 'todo-comments.nvim', 'trouble.nvim', 'lspsaga.nvim', 'vim-sneak', 'which-key.nvim', 'nvim-colorizer.lua', 'zen-mode.nvim', 'nvim-spectre'}, { event = "BufRead *" }, _G.packer_plugins)]]
vim.cmd [[au BufWinEnter * ++once lua require("packer.load")({'nvim-tree.lua', 'vim-floaterm', 'nvim-dap'}, { event = "BufWinEnter *" }, _G.packer_plugins)]]
