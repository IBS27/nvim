...
function M.config()
  -- Suppress lspconfig deprecation warning until v3 is released
  ...
  -- Rounded borders for hover/signatureHelp floats are set globally via
  -- `vim.o.winborder` in user.options (vim.lsp.with() was deprecated in 0.11).
