local LSP = {
  ...
  -- LspDiagnosticsUnderlineError = { fg = C.error_red, style = "undercurl" },
  -- LspDiagnosticsUnderlineWarning = { fg = C.warning_orange, style = "undercurl" },
  -- LspDiagnosticsUnderlineInformation = { fg = C.info_yellow, style = "undercurl" },
  -- LspDiagnosticsUnderlineHint = { fg = C.hint_blue, style = "undercurl" },
  ...
  NvimTreeGitNew = { fg = C.info_yellow },
